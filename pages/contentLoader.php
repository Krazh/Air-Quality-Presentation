<?php
$root = $_SERVER['DOCUMENT_ROOT'] . "/AirQualityPresentation/";
...
$columnChart = new FusionCharts("msline", "myFirstChart" , $width, 400, "chart-1", "json",$jsonEncodedData);
$columnChart->render();
?>
